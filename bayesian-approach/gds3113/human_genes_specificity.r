DATA <- strsplit(readLines("human_genes_tissue_specificity_final.txt",n=-1,ok=TRUE,warn=TRUE),"\n")
...
write(h_specific[!duplicated(h_specific[,1]),1],"../tissue_selective/h3113_specific.txt") #EDIT THE DIRECTORY PATH
write(h_2sel[!duplicated(h_2sel[,1]),1],"../tissue_selective/h3113_2sel.txt") #EDIT THE DIRECTORY PATH
write(h_3sel[!duplicated(h_3sel[,1]),1],"../tissue_selective/h3113_3sel.txt") #EDIT THE DIRECTORY PATH
write(h_4sel[!duplicated(h_4sel[,1]),1],"../tissue_selective/h3113_4sel.txt") #EDIT THE DIRECTORY PATH
